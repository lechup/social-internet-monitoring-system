...
:: Android packaging
set AND_CERT_NAME="facewithme"
set AND_CERT_PASS=fdds
set AND_CERT_FILE=cert\facewithme.p12
...
set IOS_PROVISION=cert\facewithme.mobileprovision
...
set APP_ID=air.facewithme.com

:: Output packages
set DIST_PATH=dist
set DIST_NAME=facewithme
