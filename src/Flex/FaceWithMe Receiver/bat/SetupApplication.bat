...
:: Android packaging
set AND_CERT_NAME="FaceWithMe Receiver"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\FaceWithMeReceiver.p12
...
set IOS_PROVISION=cert\FaceWithMeReceiver.mobileprovision
...
set APP_ID=air.FaceWithMeReceiver

:: Output packages
set DIST_PATH=dist
set DIST_NAME=FaceWithMeReceiver
