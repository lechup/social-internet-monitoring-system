...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.value'
        db.add_column('core_category', 'value',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.value'
        db.delete_column('core_category', 'value')
    ...
    models = {
        ...
        'core.entry': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'bed00b68-6f8e-45eb-9a40-6c0ba19e59df'", 'max_length': '36', 'primary_key': 'True'})
        },
        'core.server': {
