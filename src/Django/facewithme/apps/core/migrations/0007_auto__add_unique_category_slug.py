...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('core_category', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Category', fields ['slug']
        db.delete_unique('core_category', ['slug'])
    ...
    models = {
        ...
        'core.stream': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'95b6ac1f-f197-4ef3-b559-3bda929b495a'", 'max_length': '36', 'primary_key': 'True'})
        }
    }
