...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_category', 'slug',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('core_category', 'slug')
    ...
    models = {
        ...
        'core.stream': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'5d7bc637-308a-49f5-a8b5-72ee40f36e03'", 'max_length': '36', 'primary_key': 'True'})
        }
    }
