...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for category in orm['core.Category'].objects.all():
            # save model - create slug
    ...
    models = {
        ...
        'core.stream': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'dd88e5a7-46c7-4a7c-afd7-2ad10b33487c'", 'max_length': '36', 'primary_key': 'True'})
        }
    }
