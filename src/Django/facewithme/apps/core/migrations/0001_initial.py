...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_entry', (
            ('uuid', self.gf('django.db.models.fields.CharField')(default='11d39cfd-a3f8-41b2-b932-7c99dcce43b1', max_length=36, primary_key=True)),
            ...
            ('server', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['core.Server'])),
    ...
    models = {
        ...
        'core.entry': {
            ...
            'server': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['core.Server']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '255'}),
            'start': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'c76cda1b-d7dc-4f24-901b-cc8222785b32'", 'max_length': '36', 'primary_key': 'True'})
        },
        'core.server': {
