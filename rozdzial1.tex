...
\begin{itemize}
    ...
    \item zmniejszanie możliwości porażki projektu -- Dostarczanie działającego, funkcjonalnego oprogramowania bardzo szybko powoduje najczęściej zadowolenie klienta. Przekłada się to bezpośrednio na poczucie satysfakcji oraz pozytywną atmosferę wśród członków zespołu. Dzięki temu ludzie są mniej skłonni do zmiany miejsca zatrudnienia ze względu na stres, ciągłe przekraczanie terminów czy brak satysfakcji z wykonywanej pracy.
\end{itemize}
